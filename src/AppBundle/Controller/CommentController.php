...
class CommentController extends Controller
{
     ...
     *
     * @Route("/{notice_id}", name="comment_create")
     * @Method("POST")
     * @Template("AppBundle:Comment:new.html.twig")
     */
    public function createAction(Request $request, $notice_id)
    {
        $entity = new Comment();
        ...
        if ($form->isValid()) {
            ...
            $notice = $em->getRepository('AppBundle:Notice')->find($notice_id);
            $entity->setUser($this->getUser());
            $entity->setDate(new DateTime(date("Y-m-d H:i:s")));
            ...
            return $this->redirect($this->generateUrl('_show', array('id' => $notice_id)));
        }
    ...
    private function createCreateForm(Comment $entity)
    {
        $form = $this->createForm(new CommentType(), $entity, array(
            'action' => $this->generateUrl('comment_create', ['notice_id' => '0']),
            'method' => 'POST',
        ));
...

    {
        ...
        $form->getData()->setDate((date("Y-m-d H:i:s")));
